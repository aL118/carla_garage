...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nnodes=1 --nproc_per_node=8 --max_restarts=1 --rdzv_id=$SLURM_JOB_ID --rdzv_backend=c10d \
    /fs/nexus-scratch/aliu1237/carla_garage/sim2drive/adaptdino_train.py --id "${SLURM_JOB_NAME:-test}" --crop_image 1 --seed 2 --epochs 30 --batch_size 6 \
    ...
    --load_file /fs/nexus-scratch/aliu1237/carla_garage/logs/ablation_adaptdinov2/model_0016.pth \
